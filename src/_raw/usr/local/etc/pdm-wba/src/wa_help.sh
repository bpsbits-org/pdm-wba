...
wa_help(){
    ...
    echo -e "\033[1;33m  print-env \033[0m            Display current server environment type.";
    echo -e "\033[1;33m  print-nw \033[0m             Display network addresses configuration.";
    ...
    echo -e "\033[1;33m  wa-services \033[0m          Display basic list of available WA services.";
